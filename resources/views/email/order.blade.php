        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                <span style="color: #5caad2;">ĐẶT HÀNG THÀNH CÔNG</span>
                    ...
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class=" bg-warning rounded-2 p-2 ">Thông tin đơn hàng:</td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1 ">Mã đơn hàng: <span
                                class="badge bg-primary">#{{ $order->id }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1 ">Người đặt hàng: <span>{{ $order->user->name }}</span></td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1">Ngày đặt hàng: {{ $order->created_at->format('l, d/m/Y') }}
                        </td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1">Trạng thái: <span class="badge bg-primary">Đặt mới</span>
                        </td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class=" bg-warning rounded-2 p-2 ">Thông tin nhận hàng:</td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1 ">Người nhận: <span
                                class="badge bg-primary">{{ $order->receiver }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1">Địa chỉ: {{ $order->address }}</td>
                    </tr>
                    <tr>
                        <td style=" font-size: 16px; line-height: 24px;" class="text border-left pl-1">Số điện thoại: <span
                                class="badge bg-primary">{{ $order->phone }}</span>
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <td align="left"
                                            ...
                                            <div style="line-height: 35px">
                                                ...
                                                <div class="text-nowrap">
                                                    {{ number_format($item->amount * $price) }} đ</div>
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div style="line-height: 24px">
                                                ...
                                                Lorem ipsum dolor sit amet coni petur adipiscing elit. Praesent at lacus
                                                faucibus orcil viverra..
